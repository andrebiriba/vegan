...
public class goveganmore2 extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goveganmore2);
        ...
        String video = "<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/FvppRx41YDU\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>";
        ...
        midiabutton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                finish();
                Intent intent1 = new Intent ( goveganmore2.this, goveganmore.class );
                ActivityOptionsCompat actcompat = ActivityOptionsCompat.makeCustomAnimation ( getApplicationContext ( ),
                        R.anim.slide_in_left, R.anim.slide_out_left );
                ActivityCompat.startActivity ( goveganmore2.this, intent1, actcompat.toBundle ( ) );
            }
        });
        ...
        backButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent ( goveganmore2.this, Goveganmore3.class );
                ActivityOptionsCompat actcompat = ActivityOptionsCompat.makeCustomAnimation ( getApplicationContext ( ),
    ...
    private void showHelpDialog() {
        ...
        try {
            ...
            docimage.setImageDrawable(ContextCompat.getDrawable(goveganmore2.this, R.drawable.error));
        }
