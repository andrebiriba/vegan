...
public class FashionActivity extends AppCompatActivity implements Serializable {

    private ImageView mailTypeImage, selo1, selo2, selo3, selo4, fire;
    private ImageButton imageButtonBack, love;
    private Button buttonContinue;
    private TextView title, brandTv, price, descriptionTv, discountedNoteTv, mostrarmais, mostrarmenos, ingredientes, tamanho, adicionais1, valor1, valor2,
            ...
            tamanhosTv, adicionaisTv, qualidadeTv, garantiaTv, saibamaisTv, tempoentregaTv, tempoproducaoTv;
    private ImageSlider circleImageProduct;
    FirebaseAuth fAuth;
    private String isLoved, taman, adicional1, adicional2, novirgula, userID, nLikes,
            ...
            alor9, alor10, alor11, alor12, alor13, alor14, alor15, seloa, selob, seloc, selod, selos, sizepp, sizep,sizem, sizeg, sizegg, sizeggg,
    categoryProduct, productId, token, productCountry, productType, nome, discountNote, foto, localOption, scheduleProduction, nationalMail;
    ...
    private String va1, va2, va3, va4, va5, va6, va7, va8, va9, va10, va11, va12, va13, va14, va15, size;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circleImageProduct = findViewById(R.id.shapeableImageView);
        ...
        if(Objects.equals(indisponivel, "true")){
            ...
            Toast.makeText(FashionActivity.this, "Item indisponível temporariamente", Toast.LENGTH_SHORT).show();
        }
        ...
        if (!statuInternet) {
            alertOffline ( );
            Toast.makeText(FashionActivity.this, R.string.falhananet, Toast.LENGTH_SHORT).show();
        } else {
        ...
        circleImageProduct.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemSelected(int position) {
                if(position == 0){
                    androidx.appcompat.app.AlertDialog.Builder alertViewPicture = new androidx.appcompat.app.AlertDialog.Builder(FashionActivity.this, R.style.MyAlertDialogTheme);
                    LayoutInflater factory = LayoutInflater.from(FashionActivity.this);
                    ...
                    try {
                        ...
                        dialogImageView.setImageDrawable(ContextCompat.getDrawable(FashionActivity.this, R.drawable.error ));
                    }
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        try {
                            ...
                            brandPhoto.setImageDrawable(ContextCompat.getDrawable(FashionActivity.this, R.drawable.error ));
                        }
        ...
        mailTypeImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(FashionActivity.this, R.string.enviparato, Toast.LENGTH_SHORT);
            }
        });
        ...
        buttonContinue.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                } else Toast.makeText(FashionActivity.this, R.string.entreoucadastre, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        floatingButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FashionActivity.this, LoginActivity.class);
        ...
        brandPhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FashionActivity.this, RestaurantDetailsActivity.class);
    ...
    private void toastselo(String selos) {
        switch (selos) {
            case "soja":
                Toast.makeText(FashionActivity.this, R.string.nosoja, Toast.LENGTH_SHORT).show();
                break;
            case "gmo":
                Toast.makeText(FashionActivity.this, R.string.trans, Toast.LENGTH_SHORT).show();
                break;
            case "bio":
                Toast.makeText(FashionActivity.this, R.string.biode, Toast.LENGTH_SHORT).show();
                break;
            case "org":
                Toast.makeText(FashionActivity.this, R.string.organ, Toast.LENGTH_SHORT).show();
                break;
            case "rec":
                Toast.makeText(FashionActivity.this, R.string.recic, Toast.LENGTH_SHORT).show();
                break;
            case "eco":
                Toast.makeText(FashionActivity.this, R.string.ecof, Toast.LENGTH_SHORT).show();
                break;
            case "b12":
                Toast.makeText(FashionActivity.this, R.string.rb12, Toast.LENGTH_SHORT).show();
                break;
            case "cru":
                Toast.makeText(FashionActivity.this, R.string.raw, Toast.LENGTH_SHORT).show();
                break;
            case "maconha":
                Toast.makeText(FashionActivity.this, R.string.cannabis, Toast.LENGTH_SHORT).show();
                break;
            case "algodao":
                Toast.makeText(FashionActivity.this, R.string.algodao, Toast.LENGTH_SHORT).show();
                break;
            case "parabeno":
                Toast.makeText(FashionActivity.this, R.string.parabenfree, Toast.LENGTH_SHORT).show();
                break;
            case "gluten":
                Toast.makeText(FashionActivity.this, R.string.nogluten, Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    private void showQuantityDialog() {
        ...
        if(!Objects.equals(discountNote, "")){
            originalPriceTv.append(priceOriginal.replace(".",","));
            priceDiscountedTv.append(discountPrice.replace(".",","));
            discountedNoteTv.setVisibility(View.VISIBLE);
            discountedNoteTv.setText(discountNote+"% OFF");
            originalPriceTv.setPaintFlags(originalPriceTv.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        } else {
            priceDiscountedTv.append(priceOriginal.replace(".",","));
            originalPriceTv.setVisibility(GONE);
            priceDiscountedTv.setVisibility(VISIBLE);
        }
        try {
            Picasso.get().load(foto).placeholder(R.drawable.loading).into(productIv);
        }
        ...
        incrementBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                quantity++;
                finalPrice = finalPrice + Double.parseDouble(novirgula.replace(finalCoin1,""));
                        ...
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                FirebaseFirestore.getInstance().collection("Cart "+userID)
                                    ...
                                    DocumentReference docRef2 = fStore.collection("Cart "+userID).document(productId);
                                    ...
                                    Double calculo = Double.parseDouble(prici.replace(",",".").replace(finalCoin1,""));
                                    ...
                                    docRef2.set(cart).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Intent intent = new Intent(FashionActivity.this, Order.class);
                                        ...
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(FashionActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            }
        ...
        if(userID != null) {
            ...
            ref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (loveDB.equals("true")) {
                        ...
                        try {
                            ...
                            love.setImageDrawable(ContextCompat.getDrawable(FashionActivity.this, error ));
                        }
                    } else {
                        isLoved = "false";
                        try {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(FashionActivity.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            try {
                                ...
                                DocumentReference docRef = fStore.collection("Closet").document(productId);
                                docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                    @Override
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if (task.isSuccessful()) {
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            if (document.exists()) {
                                                ...
                                                hashMap.put("shopUid",""+shopUid);
                                                hashMap.put("likes",""+cal2);
                                                DocumentReference docRef2 = fStore.collection("Closet").document(productId);
