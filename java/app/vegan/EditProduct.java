...
public class EditProduct extends AppCompatActivity implements Serializable {
    private ImageButton backBtn;
    private ImageView image, productIconIv, productIcon2, productIcon3;
    ...
    private EditText ingredientsEt, estoqueEt, deliveryTimeEt, qualityEt, securePolicyEt, scheduleProduction, moreInfoEt,
    ...
    private FloatingActionButton updateProductBtn;
    private String productId, uid, productCategory,nationalMail, internationalMail, productBrand, productType, photoclicked, productI1, productI2,
    productI3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        indispo = findViewById(R.id.indispo);
        ...
        adicionar3 = findViewById(R.id.adicionar3);
        ...
        internationalMail = getIntent().getStringExtra("internationalMail");
        nationalMail = getIntent().getStringExtra("nationalMail");

        if (Objects.equals(productType, "Closet") || Objects.equals(productType, "Others")) {
        ...
        launcher=
                registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),(ActivityResult result)->{
                    if(result.getResultCode()==RESULT_OK){
                        ...
                        Toast.makeText(EditProduct.this, result.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        productIconIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(productCategory)){
                    Toast.makeText(EditProduct.this, R.string.categnec, Toast.LENGTH_SHORT).show();
                } else {
                    showImagePickDialog();
        ...
        adicionar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                adicionar.setVisibility(View.GONE);
                    ...
                    Toast.makeText(EditProduct.this, "A imagem precisa ser menor que 250 KB", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void loadProductDetails() {
        ...
        DocumentReference rootRef = fStore.collection(productCategory).document(productId);
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        productId = document.getString("productId");
                            String productTitle = document.getString("productTitle");
                            ...
                            String productQuantity = document.getString("productQuantity");
                             productI1 = document.getString("productIcon");
                         productI2 = document.getString("productIcon2");
                         productI3 = document.getString("productIcon3");
                        String originalPrice = document.getString("originalPrice");
                            String discountPrice = document.getString("discountPrice");
                            String discountNote = document.getString("discountNote");
                            String discountAvailable = document.getString("discountAvailable");
                            ...
                            try {
                                Picasso.get().load(productI1).placeholder(R.drawable.loading).into(productIconIv);
                            } catch (Exception e) {
                                productIconIv.setImageResource(R.drawable.error);
                            }
                            if (!Objects.equals(productI2, "") && productI2!= null) {
                                productIcon2.setVisibility(View.VISIBLE);
                                try {
                                    Picasso.get().load(productI2).placeholder(R.drawable.loading).into(productIcon2);
                                } catch (Exception e) {
                                    productIcon2.setImageResource(R.drawable.error);
                                }
                            }
                        if (!Objects.equals(productI3, "") && productI3!= null) {
                            if (Objects.equals(TypeTv.getText().toString(), "Closet")
                                    || Objects.equals(TypeTv.getText().toString(), "Others")) {
                                try {
                                    Picasso.get().load(productI3).placeholder(R.drawable.loading).into(productIcon3);
                                } catch (Exception e) {
                                    productIcon3.setImageResource(R.drawable.error);
                                }
                            }
                        }
                        }
    ...
    private String productTitle, productDescription, sizepersonaliza, productQuantity, originalPrice, discountPrice, discountNote,
    ...
    private boolean discountAvailable,checpp, checp, checm, checg, checgg, checggg, checkgluten, checksoy, cRaw, cB12, cEcofriend,
    ...
    private void updateProduct() {
        ...
        hashMap.put("productCountry",""+count);
        hashMap.put("productState",""+stat);
        hashMap.put("productCity",""+cit);
        hashMap.put("indisponivel",""+indispo.isChecked());
        ...
        if(image_uri1!=null) {
            ...
            StorageReference photoRef = mFirebaseStorage.getReferenceFromUrl(productI1);
            ...
            photoRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    if(productI2!=null&& !productI2.equals("")){

                        StorageReference photoRef2 = mFirebaseStorage.getReferenceFromUrl(productI2);
                    ...
                    if(productI3!=null&& !productI3.equals("")){

                        StorageReference photoRef3 = mFirebaseStorage.getReferenceFromUrl(productI3);
            ...
            storageReference.putFile(image_uri1)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            DocumentReference docRef = fStore.collection(CollectionName).document(productId);
                            docRef.update(hashMap1).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    DocumentReference docRef = fStore.collection(CollectionName).document(productId);
                                    docRef.update(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            if(image_uri2!=null) {
                                                ...
                                                String filePathAndName2 = "product_images/" + "2" + productId;
                                                ...
                                                storageReference2.putFile(image_uri2)
                                                        .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                            ...
                                                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                                ...
                                                                Log.d(TAG, "getdownloadImageUri " + downloadImageUri);
                                                                ...
                                                                docRef.update(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                    ...
                                                                    public void onSuccess(Void aVoid) {
                                                                        ...
                                                                        if(image_uri3!=null) {
                                                                            ...
                                                                            String filePathAndName3 = "product_images/" + "3" + productId;
                                                                                        ...
                                                                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                                                            ...
                                                                                            docRef.update(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                ...
                                                                                                public void onSuccess(Void aVoid) {
                                                                                                    ...
                                                                                                    Toast.makeText(EditProduct.this, "Produto Atualizado", Toast.LENGTH_SHORT).show();
                                                                                                    startVibrate(100);
                                                                                                }
                                                                                            }).addOnFailureListener(new OnFailureListener() {
                                                                                                @Override
        ...
        if(checkNacional.isChecked() || checkImportado.isChecked()){
            if(checkNacional.isChecked()) {
                ...
                DocumentReference admRef = fStore.collection("Adm's").document(uid);
                admRef.set(hashMap2).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        progressDialog.dismiss();
                        Toast.makeText(EditProduct.this, R.string.produtoadd, Toast.LENGTH_SHORT).show();
                        startVibrate ( 100 );
