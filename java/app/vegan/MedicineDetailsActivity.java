...
public class MedicineDetailsActivity extends AppCompatActivity implements Serializable {

    private ImageButton imageButtonBack, orderButton;
    private TextView titleDetails, brandTv, priceDetail, quantityDietDetailsTv,
            descriptionDetailsTv, discountedNoteTv, mostrarmais, mostrarmenos, ingredientes, tamanho, adicionais1, valor1, valor2,
            ...
            tamanhosTv, adicionaisTv, qualidadeTv, garantiaTv, saibamaisTv, tempoproducaoTv;
    private ImageView mailTypeImage, selo1, selo2, selo3, selo4, love, incrementBtn, decrementBtn, fire;
    FirebaseAuth fAuth;
    private String userID, isLoved, seloa, selob, seloc, selod, selos, taman,nome, discountNote, foto,
            adicional1, adicional2, nLikes,productId,sizepp, sizep, sizem, sizeg, sizegg, sizeggg,categoryProduct,
            ...
            alor9, alor10, alor11, alor12, alor13, alor14, alor15, token, productCountry, productType, size, localOption, nationalMail;
    ...
    private String adc1, adc2, adc3, adc4, adc5, adc6, adc7, adc8, adc9, adc10, adc11, adc12, adc13, adc14, adc15, finalcoin,
            scheduleProduction;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String deliveryOption = data.getStringExtra("deliveryOption");
        String estoque = data.getStringExtra("estoque");
        ...
        layoutmais = findViewById(R.id.layoutmore);
        mostrarmais = findViewById(R.id.mostrarmas);
        brandPhoto = findViewById(R.id.brandPhoto);
        love = findViewById(R.id.imageView74);
        selo4 = findViewById(R.id.imageView73);
        selo3 = findViewById(R.id.imageView72);
        selo2 = findViewById(R.id.imageView71);
        selo1 = findViewById(R.id.imageView70);
        mailTypeImage = findViewById(R.id.imageView40);
        titleDetails = findViewById(R.id.textView25);
        brandTv = findViewById(R.id.textViewBrand);
        priceDetail = findViewById(R.id.textView13);
        descriptionDetailsTv = findViewById(R.id.textView26);
        circleImageProduct = findViewById(R.id.imageView5);
        incrementBtn = findViewById(R.id.textView29);
        decrementBtn = findViewById(R.id.textView28);
        quantityDietDetailsTv = findViewById(R.id.textView31);
        orderButton = findViewById(R.id.imageButton);
        floatingButton = findViewById(R.id.floatingButton);
        discountedNoteTv = findViewById(R.id.discountedNoteTv);

        if(Objects.equals(indisponivel, "true")){
            orderButton.setEnabled(false);
            Toast.makeText(MedicineDetailsActivity.this, "Item indisponível temporariamente", Toast.LENGTH_SHORT).show();
        }
        ...
        if (!statuInternet) {
            alertOffline ( );
            Toast.makeText(MedicineDetailsActivity.this, R.string.falhananet, Toast.LENGTH_SHORT).show();
        } else {
        ...
        mostrarmais.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                descriptionDetailsTv.setMaxLines(10);
                mostrarmais.setVisibility(GONE);
            }
        });
        mostrarmenos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                descriptionDetailsTv.setMaxLines(4);
        ...
        circleImageProduct.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemSelected(int position) {
                if (position == 0) {
                    AlertDialog.Builder alertViewPicture = new AlertDialog.Builder(MedicineDetailsActivity.this, R.style.MyAlertDialogTheme);
                    LayoutInflater factory = LayoutInflater.from(MedicineDetailsActivity.this);
                    ...
                    try {
                        ...
                        dialogImageView.setImageDrawable(ContextCompat.getDrawable(MedicineDetailsActivity.this, R.drawable.error));
                    }
        ...
        if (!Objects.equals(discountNote, "")) {
            ...
            priceDetail.append(discountPrice.replace(".", ","));
        } else {
            fire.setVisibility(GONE);
            discountedNoteTv.setVisibility(GONE);
            priceDetail.append(priceOriginal.replace(".", ","));
        }
        descriptionDetailsTv.setText(descriptionProduct);
        titleDetails.setText(nome);
        ...
        if (LocalOption != null && !LocalOption.equals("")) {
            tempoentrega.setText(R.string.dispapenret);
        }
        ...
        if (adicional1 != null && !adicional1.equals("") && !adicional1.equals("false")) {
            ...
            adicionais1.setVisibility(GONE);
            valor1.setVisibility(GONE);
            adicionaisTv.setVisibility(GONE);
            numeral1.setVisibility(GONE);
        }
        if (adicional2 != null && !adicional2.equals("") && !adicional2.equals("false")) {
            ...
            adicionais2.setVisibility(GONE);
            valor2.setVisibility(GONE);
            numeral2.setVisibility(GONE);
        }
        if (adicional3 != null && !adicional3.equals("") && !adicional3.equals("false")) {
            ...
            adicionais3.setVisibility(GONE);
            valor3.setVisibility(GONE);
            numeral3.setVisibility(GONE);
        }
        if (adicional4 != null && !adicional4.equals("") && !adicional4.equals("false")) {
            ...
            adicionais4.setVisibility(GONE);
            valor4.setVisibility(GONE);
            numeral4.setVisibility(GONE);
        }
        if (adicional5 != null && !adicional5.equals("") && !adicional5.equals("false")) {
            ...
            adicionais5.setVisibility(GONE);
            valor5.setVisibility(GONE);
            numeral5.setVisibility(GONE);
        }
        if (adicional6 != null && !adicional6.equals("") && !adicional6.equals("false")) {
            ...
            adicionais6.setVisibility(GONE);
            valor6.setVisibility(GONE);
            numeral6.setVisibility(GONE);
        }
        if (adicional7 != null && !adicional7.equals("") && !adicional7.equals("false")) {
            ...
            adicionais7.setVisibility(GONE);
            valor7.setVisibility(GONE);
            numeral7.setVisibility(GONE);
        }
        if (adicional8 != null && !adicional8.equals("") && !adicional8.equals("false")) {
            ...
            adicionais8.setVisibility(GONE);
            valor8.setVisibility(GONE);
            numeral8.setVisibility(GONE);
        }
        if (adicional9 != null && !adicional9.equals("") && !adicional9.equals("false")) {
            ...
            adicionais9.setVisibility(GONE);
            valor9.setVisibility(GONE);
            numeral9.setVisibility(GONE);
        }
        if (adicional10 != null && !adicional10.equals("") && !adicional10.equals("false")) {
            ...
            adicionais10.setVisibility(GONE);
            valor10.setVisibility(GONE);
            numeral10.setVisibility(GONE);
        }
        if (adicional11 != null && !adicional11.equals("") && !adicional11.equals("false")) {
            ...
            adicionais11.setVisibility(GONE);
            valor11.setVisibility(GONE);
            numeral11.setVisibility(GONE);
        }
        if (adicional12 != null && !adicional12.equals("") && !adicional12.equals("false")) {
            ...
            adicionais12.setVisibility(GONE);
            valor12.setVisibility(GONE);
            numeral12.setVisibility(GONE);
        }
        if (adicional13 != null && !adicional13.equals("") && !adicional13.equals("false")) {
            ...
            adicionais13.setVisibility(GONE);
            valor13.setVisibility(GONE);
            numeral13.setVisibility(GONE);
        }
        if (adicional14 != null && !adicional14.equals("") && !adicional14.equals("false")) {
            ...
            adicionais14.setVisibility(GONE);
            valor14.setVisibility(GONE);
            numeral14.setVisibility(GONE);
        }
        if (adicional15 != null && !adicional15.equals("") && !adicional15.equals("false")) {
            ...
            adicionais15.setVisibility(GONE);
            valor15.setVisibility(GONE);
            numeral15.setVisibility(GONE);
        }
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        try {
                            ...
                            brandPhoto.setImageDrawable(ContextCompat.getDrawable(MedicineDetailsActivity.this, R.drawable.error));
                        }
                    }
                }
            }
        ...
        brandPhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MedicineDetailsActivity.this, RestaurantDetailsActivity.class);
        ...
        mailTypeImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MedicineDetailsActivity.this, R.string.enviparato, Toast.LENGTH_SHORT);
            }
        });
        ...
        incrementBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                quantityDietDetailsTv.setText(String.valueOf(quantity));
            }
        });
        decrementBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (quantity > 1) {
                    ...
                    quantityDietDetailsTv.setText("" + quantity);
                }
            }
        });
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MedicineDetailsActivity.this, LoginActivity.class);
        ...
        orderButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if ( fAuth.getCurrentUser ( ) != null ) {
                    ...
                    Toast.makeText(MedicineDetailsActivity.this, R.string.entreoucadastre, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        love.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                } else Toast.makeText(MedicineDetailsActivity.this, R.string.entreoucadastre, Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if(Objects.equals(sizePersonalized, "true")){
                            ...
                            titleTv.setText(getString(R.string.digiteotamanho));
    ...
    private void order() {
        ...
        String nome = data.getStringExtra("title");
        String foto = data.getStringExtra("photo");
        String price = priceDetail.getText().toString();
        String priceOriginal = data.getStringExtra("priceOriginal");
        String quantityProduct = data.getStringExtra("quantityProduct");
        String descriptionProduct = data.getStringExtra("descriptionProduct");
        String shopUid = data.getStringExtra("shopUid");
        ...
        String finalcoin = "";
        if(Objects.equals(productCountry, getResources().getString(R.string.brasil))){
            finalcoin = "R$";
        }
        if(Objects.equals(productCountry, getResources().getString(R.string.eua))){
            finalcoin = "US$";
        }
        if(Objects.equals(productCountry, getResources().getString(R.string.inglaterra))){
            finalcoin = "£";
        }
        if(Objects.equals(productCountry, getResources().getString(R.string.alemanha))){
            finalcoin = "€";
        }
        if(Objects.equals(productCountry, getResources().getString(R.string.franca))){
            finalcoin = "€";
        }
        if(Objects.equals(productCountry, getResources().getString(R.string.canada))){
            finalcoin = "C$";
        }
        if(Objects.equals(productCountry, getResources().getString(R.string.portugal))){
            finalcoin = "€";
        }
        if(Objects.equals(productCountry, getResources().getString(R.string.espanha))){
            finalcoin = "€";
        }
        if(Objects.equals(productCountry, getResources().getString(R.string.mexico))){
            finalcoin = "MEX$";
        ...
        cart.put("price",price.replace(",",".").replace(finalcoin,""));
                        ...
                        FirebaseFirestore.getInstance().collection("Cart "+userID)
                            ...
                            docRef.set(cart).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Intent intent = new Intent(MedicineDetailsActivity.this, Order.class);
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(MedicineDetailsActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
    ...
    private void toastselo(String selos) {
        switch (selos) {
            case "soja":
                Toast.makeText(MedicineDetailsActivity.this, getResources().getString(R.string.nosoja), Toast.LENGTH_SHORT).show();
                break;
            case "gmo":
                Toast.makeText(MedicineDetailsActivity.this, getResources().getString(R.string.trans), Toast.LENGTH_SHORT).show();
                break;
            case "bio":
                Toast.makeText(MedicineDetailsActivity.this, getResources().getString(R.string.biode), Toast.LENGTH_SHORT).show();
                break;
            case "org":
                Toast.makeText(MedicineDetailsActivity.this, getResources().getString(R.string.organ), Toast.LENGTH_SHORT).show();
                break;
            case "rec":
                Toast.makeText(MedicineDetailsActivity.this, getResources().getString(R.string.recic), Toast.LENGTH_SHORT).show();
                break;
            case "eco":
                Toast.makeText(MedicineDetailsActivity.this, getResources().getString(R.string.ecofriendly), Toast.LENGTH_SHORT).show();
                break;
            case "b12":
                Toast.makeText(MedicineDetailsActivity.this, getResources().getString(R.string.rb12), Toast.LENGTH_SHORT).show();
                break;
            case "cru":
                Toast.makeText(MedicineDetailsActivity.this, R.string.raw, Toast.LENGTH_SHORT).show();
                break;
            case "maconha":
                Toast.makeText(MedicineDetailsActivity.this, R.string.cannabis, Toast.LENGTH_SHORT).show();
                break;
            case "algodao":
                Toast.makeText(MedicineDetailsActivity.this, R.string.algodao, Toast.LENGTH_SHORT).show();
                break;
            case "parabeno":
                Toast.makeText(MedicineDetailsActivity.this, R.string.parabenfree, Toast.LENGTH_SHORT).show();
                break;
            case "gluten":
                Toast.makeText(MedicineDetailsActivity.this, R.string.nogluten, Toast.LENGTH_SHORT).show();
                break;
        }
    }
        ...
        if(userID != null) {
            ...
            ref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (loveDB.equals("true")) {
                        ...
                        try {
                            ...
                            love.setImageDrawable(ContextCompat.getDrawable(MedicineDetailsActivity.this, error ));
                        }
                    } else {
                        isLoved = "false";
                        try {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(MedicineDetailsActivity.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            try {
                                ...
                                DocumentReference docRef = fStore.collection("Pharmacy").document(productId);
                                docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                    @Override
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if (task.isSuccessful()) {
    ...
    private void loved() {
        ...
        String nome = data.getStringExtra("title");
        String brandName = data.getStringExtra("brandName");
        String lojauid = data.getStringExtra("shopUid");
        String Id = data.getStringExtra("productId");
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            if (document.exists()) {
                                                ...
                                                hashMap.put("shopUid",""+shopUid);
                                                hashMap.put("likes",""+cal2);
                                                DocumentReference docRef2 = fStore.collection("Pharmacy").document(productId);
